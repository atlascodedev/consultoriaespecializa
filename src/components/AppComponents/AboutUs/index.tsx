...
import consultoria2 from "../../../images/especializa-2.png"
...
const AboutUs = ({}: Props) => {
  ...
  return (
    <div style={{ overflow: "hidden" }}>
      <Waypoint bottomOffset={deviceSize} onEnter={() => setAboutUsOne(true)} />
      <AboutUsRoot>
        <AboutUsSection>
      ...
      <Waypoint bottomOffset={deviceSize} onEnter={() => setAboutUsTwo(true)} />
      <AboutUsSecondRoot>
        <AboutUsSection>
          <div className={"offsetRoot-2"}>
            <Slide in={aboutUsTwo} direction={"left"} timeout={{ enter: 1000 }}>
              <div
                ...
                style={{ position: "relative", top: "-110px" }}
              >
                <OffsetPictureCard imageUrl={consultoria2} />
              </div>
            </Slide>
          </div>
